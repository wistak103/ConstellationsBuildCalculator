let version = "CONST-R86";

let activeSkillTree = Onehanded;
...
function loadData() {
    ...
    if(urlParams.has('b')) {
        ...
        let buildName = values[1];
        let buildRace = values[2];
        let buildStone = values[3];
		...
		//class data
		let professionIndex = values[10];
		let professionName = values[11];
		let professionAttributeIndex = values[12];
		let professionSkillGroupIndex = values[13];
		professionSkills[0] = values[14];
		professionSkills[1] = values[15];
		professionSkills[2] = values[16];
		professionSkills[3] = values[17];
		professionSkills[4] = values[18];
		professionSkills[5] = values[19];
