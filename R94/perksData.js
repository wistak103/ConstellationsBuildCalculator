...
Onehanded.perks = [
	...
	//2
	{
		name: "Penetrating Strikes", skill: Onehanded, skillReq: 20,
		 ...
		 description: "Your power attacks with one-handed weapons are now devastating enough to penetrate enemy armor and less exhausting.<br>[-40% power attack stamina cost, +5% armor penetration]",
		 labels: [], lines: [], chainPerks: []
	},
	//3
	{
	...
	//6
	{
		name: "Axe Focus", skill: Onehanded, skillReq: 25,
		 ...
		 description: "You've become familiar with one-handed axes.<br>[10% more damage, +8% armor penetration]",
		 labels: [], lines: [], chainPerks: []
	},
	//7
	{
		name: "Axe Focus", skill: Onehanded, skillReq: 50,
		 ...
		 description: "You've become an advanced one-handed axe fighter.<br>[20% more damage, +16% armor penetration]",
		 labels: [], lines: [], chainPerks: []
	},
	//8
	{
		name: "Axe Focus", skill: Onehanded, skillReq: 75,
		 ...
		 description: "You've become a master of one-handed axe combat.<br>[30% more damage, +24% armor penetration]",
		 labels: [], lines: [], chainPerks: []
	},
	//9
	{
	...
	//12
	{
		name: "Sword/Spear Focus", skill: Onehanded, skillReq: 25,
		 ...
		 description: "You've learned the basics of one-handed sword and spear combat.<br>[+9% attack speed, +6% armor penetration]",
		 labels: [], lines: [], chainPerks: []
	},
	//13
	{
		name: "Sword/Spear Focus", skill: Onehanded, skillReq: 50,
		 ...
		 description: "You've acquired the advanced techniques of fighting with one-handed swords and spears.<br>[+18% attack speed, +12% armor penetration]",
		 labels: [], lines: [], chainPerks: []
	},
	//14
	{
		name: "Sword/Spear Focus", skill: Onehanded, skillReq: 75,
		 ...
		 description: "You've become a master of one-handed swords and spears.<br>[+27% attack speed, +18% armor penetration]",
		 labels: [], lines: [], chainPerks: []
	},
	//15
	{
...
Twohanded.perks = [
	//0
	{
		name: "Great Weapon Mastery", skill: Twohanded, skillReq: 0,
		 xPos: 42, yPos: 85, preReqs: [], chain: 2,  rank: 1,
	...
	{
		name: "Great Weapon Mastery", skill: Twohanded, skillReq: 0,
		 xPos: 42, yPos: 85, preReqs: [0], chain: 2,  rank: 2,
	...
	//2
	{
		name: "Barbaric Might", skill: Twohanded, skillReq: 20,
		 ...
		 description: "Your power attacks become mighty blows that will penetrate armor and are less tiring.<br>[-25% power attack stamina cost, +5% armor penetration]",
		 labels: [], lines: [], chainPerks: []
	},
	//3
	{
		name: "Devastating Strike", skill: Twohanded, skillReq: 50,
		 xPos: 51, yPos: 55, preReqs: [2], chain: 0,
	...
	//4
	{
		name: "Shatter Defense", skill: Twohanded, skillReq: 75,
		 xPos: 31, yPos: 23, preReqs: [3,7], chain: 0,
	...
	//5
	{
		name: "Devastating Cleave", skill: Twohanded, skillReq: 75,
		 xPos: 51, yPos: 23, preReqs: [3,7], chain: 0,
	...
	//7
	{
		name: "Devastating Charge", skill: Twohanded, skillReq: 50,
		 xPos: 31, yPos: 55, preReqs: [2], chain: 0,
	...
	//8
	{
		name: "Axe/Halberd Focus", skill: Twohanded, skillReq: 25,
		 xPos: 16, yPos: 66, preReqs: [2], chain: 3,  rank: 1,
		 description: "You've become familiar with two-handed axes and halberds.<br>[10% more damage, +8% armor penetration]",
		 labels: [], lines: [], chainPerks: []
	},
	//9
	{
		name: "Axe/Halberd Focus", skill: Twohanded, skillReq: 50,
		 xPos: 16, yPos: 66, preReqs: [8], chain: 3,  rank: 2,
		 description: "You've become an advanced fighter with two-handed axes and halberds.<br>[20% more damage, +16% armor penetration]",
		 labels: [], lines: [], chainPerks: []
	},
	//10
	{
		name: "Axe/Halberd Focus", skill: Twohanded, skillReq: 75,
		 xPos: 16, yPos: 66, preReqs: [9], chain: 3,  rank: 3,
		 description: "You've become a master of two-handed axes and halberds.<br>[30% more damage, +24% armor penetration]",
		 labels: [], lines: [], chainPerks: []
	},
	//11
	{
		name: "Sword/Spear Focus", skill: Twohanded, skillReq: 25,
		 xPos: 67, yPos: 66, preReqs: [2], chain: 3,  rank: 1,
	...
	//12
	{
		name: "Sword/Spear Focus", skill: Twohanded, skillReq: 50,
		 xPos: 67, yPos: 66, preReqs: [11], chain: 3,  rank: 2,
	...
	//13
	{
		name: "Sword/Spear Focus", skill: Twohanded, skillReq: 75,
		 xPos: 67, yPos: 66, preReqs: [12], chain: 3,  rank: 3,
	...
	//14
	{
		name: "Blunt Weapon Focus", skill: Twohanded, skillReq: 25,
		 xPos: 86, yPos: 66, preReqs: [2], chain: 3,  rank: 1,
	...
	//15
	{
		name: "Blunt Weapon Focus", skill: Twohanded, skillReq: 50,
		 xPos: 86, yPos: 66, preReqs: [14], chain: 3,  rank: 2,
		 description: "You've become an advanced blunt weapon fighter and know how to find weak spots in enemy armor.<br>[10% more power attack damage, +30% armor penetration]",
		 labels: [], lines: [], chainPerks: []
	},
	//16
	{
		name: "Blunt Weapon Focus", skill: Twohanded, skillReq: 75,
		 xPos: 86, yPos: 66, preReqs: [15], chain: 3,  rank: 3,
		 description: "You've become a masterly blunt weapon fighter, rendering armor almost useless.<br>[15% more power attack damage, +45% armor penetration]",
		 labels: [], lines: [], chainPerks: []
	},
];
...
Marksman.perks = [
	...
	//11
	{
		name: "Hunter", skill: Marksman, skillReq: 15,
		 xPos: 67, yPos: 70, preReqs: [0], chain: 0,
...
Block.perks = [
	...
	//1
	{
		name: "Strong Grip", skill: Block, skillReq: 15,
		 ...
		 description: "You hold on to your shield like you would hold on to your life.<br>[75% less shield weight, 10% more armor rating, block 30% more damage, arrows that hit the shield do no damage]",
		 labels: [], lines: [], chainPerks: []
	},
	//2
	{
...
Evasion.perks = [
	...
	//3
	{
		name: "Meteoric Reflexes", skill: Evasion, skillReq: 100,
		 ...
		 description: "Your reflexes are lightning fast.<br>[50% chance to take 95% less melee damage when wearing no heavy armor]",
		 labels: [], lines: [], chainPerks: [], choiceNeeded: true
	},
	//4
	{
	...
	//10
	{
		name: "Unarmored", skill: Evasion, skillReq: 20,
		 ...
		 description: "Having no weight on your body allows you to control your moves better in combat.<br>[while unarmored: +60 armor rating, +5% movement speed, +10% stamina regeneration]",
		 labels: [], lines: [], chainPerks: []
	},
	//11
	{
		name: "Unarmored", skill: Evasion, skillReq: 40,
		 ...
		 description: "Having no weight on your body allows you to control your moves better in combat.<br>[while unarmored: +120 armor rating, +10% movement speed, +20% stamina regen]",
		 labels: [], lines: [], chainPerks: []
	},
];
...
Lockpicking.perks = [
	...
	//2
	{
		name: "Masterly Lockpicking", skill: Lockpicking, skillReq: 90,
		 ...
		 description: "You learned everything there is to know about the art of lockpicking. Your expertise increases by 35 points,<br>you can now pick expert locks without difficulty and locks can be picked in plain sight with nobody noticing.",
		 labels: [], lines: [], chainPerks: []
	},
	//3
	{
...
Alteration.perks = [
	...
	//10
	{
		name: "Improved Mage Armor", skill: Alteration, skillReq: 25,
		 ...
		 description: "You've mastered the art of casting armor spells, their effect is increased by 20%, their duration is increased by 100%. Additionally you take 20% less damage from ranged attacks while a mage armor spell is active. (less effective when wearing light/heavy armor)",
		 labels: [], lines: [], chainPerks: []
	},
	//11
	{
...
Conjuration.perks = [
	...
	//18
	{
		name: "Elemental Binding", skill: Conjuration, skillReq: 75,
		 ...
		 description: "Your knowledge of Oblivion's elemental aspects increases the strength of all your summoned Atronachs and increases their duration by 50%.",
		 labels: [], lines: [], chainPerks: []
	},
	//19
	{
...
Destruction.perks = [
	...
	//5
	{
		name: "Extended Cloaks", skill: Destruction, skillReq: 50,
		 ...
		 description: "Specialising in cloak spells allows you to empower them with increased duration and increased area of effect.<br>[+60% area/duration]",
		 labels: [], lines: [], chainPerks: []
	},
	//6
	{
		name: "Extended Cloaks", skill: Destruction, skillReq: 75,
		 ...
		 description: "Your mastery over cloak spells allows you to empower them with even greater duration and area of effect.<br>[+120% area/duration]",
		 labels: [], lines: [], chainPerks: []
	},
	//7
	{
	...
	//36
	{
		name: "Unstable Surge", skill: Destruction, skillReq: 75,
		 xPos: 85, yPos: 52, preReqs: [35], chain: 2,  rank: 2,
...
Enchanting.perks = [
	...
	//10
	{
		name: "Staff Channeling", skill: Enchanting, skillReq: 50,
		 xPos: 33, yPos: 76, preReqs: [11], chain: 0,
		 description: "You can use your magic staff to channel arcane power, making spells, scrolls, and staffs stronger.<br>[while having staff equipped: +15% magnitude and duration, -30% staff charge cost]",
		 labels: [], lines: [], chainPerks: []
	},
	//11
	{
		name: "Arcane Artificery", skill: Enchanting, skillReq: 10,
	...
	//12
	{
		name: "Arcane Artificery", skill: Enchanting, skillReq: 20,
		 xPos: 30, yPos: 85, preReqs: [11], chain: 2,  rank: 2,
	...
	//14
	{
		name: "Arcane Scholar", skill: Enchanting, skillReq: 60,
		 xPos: 19, yPos: 70, preReqs: [13], chain: 3,  rank: 2,
	...
	//15
	{
		name: "Arcane Scholar", skill: Enchanting, skillReq: 90,
		 xPos: 19, yPos: 70, preReqs: [13], chain: 3,  rank: 3,
		 description: "Through meticulous study, you unlock hidden potentials in scrolls and staffs, boosting their spell magnitude and duration.<br>[+2.25% magnitude/duration for each point in your Enchantment skill]",
		 labels: [], lines: [], chainPerks: []
	},
];
