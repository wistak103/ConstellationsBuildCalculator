...
enchanting.perks = [
   ...
   restoration.perks = [
    ...
    //16
    {
        ...
        description: "You've learned the art of weaving mystical energies into your spells, <br> making all of them more effective against the undead and Daedra.<br>[+20% magnitude, +40% duration]",
        labels: [], lines: []
    },
    //17
    {
    ...
    //18
    {
        ...
        description: "You now are able to greatly intensify the potency of your poison spells. Thus, they now have even more duration.<br>[+50% duration]",
        labels: [], lines: [], chainPerks: []
    },
    //19
    {
    ...
    //20
    {
        name: "Poison<br>Master", skill: restoration, skillReq: 90,
        xPos: 120 / 4, yPos: 30 / 4, preReqs: [19], chain: 0,
        description: "Your mastery over poison grants you resistance to it, while also empowering your poison spells even further.<br>[25% resistance, 5% magnitude, 10% spell cost reduction]",
        labels: [], lines: []
    },
   ];
...
smithing.perks = [
    ...
    //1
    {
        ...
        xPos: 180 / 5, yPos: 200 / 3.5, preReqs: [0], chain: 0,
    ...
    //2
    {
        ...
        xPos: 180 / 5, yPos: 140 / 3.5, preReqs: [1], chain: 0,
    ...
    //3
    {
        ...
        xPos: 300 / 5, yPos: 115 / 3.5, preReqs: [1], chain: 0,
    ...
    //4
    {
        ...
        xPos: 300 / 5, yPos: 240 / 3.5, preReqs: [0], chain: 2, rank: 1, 
    ...
    //5
    {
        ...
        xPos: 300 / 5, yPos: 240 / 3.5, preReqs: [4], chain: 2, rank: 2, 
    ...
    //6
    {
        ...
        xPos: 115 / 5, yPos: 240 / 3.5, preReqs: [0], chain: 0, 
    ...
    //7
    {
        ...
        xPos: 48 / 5, yPos: 175 / 3.5, preReqs: [6, 10, 11], chain: 0,
    ...
    //8
    {
        ...
        xPos: 70 / 5, yPos: 100 / 3.5, preReqs: [7, 12], chain: 0,
    ...
    //9
    {
        ...
        xPos: 380 / 5, yPos: 240 / 3.5, preReqs: [0], chain: 0,
    ...
    //10
    {
        ...
        xPos: 330 / 5, yPos: 180 / 3.5, preReqs: [4, 7, 9], chain: 0,
    ...
    //11
    {
        ...
        xPos: 410 / 5, yPos: 170 / 3.5, preReqs: [4, 7, 9], chain: 0,
    ...
    //12
    {
        ...
        xPos: 380 / 5, yPos: 100 / 3.5, preReqs: [8, 10, 11], chain: 0, 
