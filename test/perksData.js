...
Onehanded.perks = [
  //0
  {
    name: "Weapon Mastery", skill: Onehanded, skillReq: 0,
     xPos: 56, yPos: 84, preReqs: [], chain: 0,
  ...
  //1
  {
    name: "Hastened Strikes", skill: Onehanded, skillReq: 20,
     xPos: 56, yPos: 73, preReqs: [0], chain: 0,
     description: "Your attacks with one-handed weapons are faster and less exhausting.<br>[-25% power attack stamina cost, +10% attack speed]",
     labels: [], lines: [], chainPerks: []
  },
  //2
  {
    name: "Powerful Strike", skill: Onehanded, skillReq: 50,
     xPos: 42, yPos: 55, preReqs: [1], chain: 0,
  ...
  //3
  {
    name: "Stunning Charge", skill: Onehanded, skillReq: 100,
     xPos: 51, yPos: 10, preReqs: [2,4], chain: 0,
  ...
  //4
  {
    name: "Powerful Charge", skill: Onehanded, skillReq: 50,
     xPos: 65, yPos: 55, preReqs: [1], chain: 0,
     description: "You have learned to perform a leaping power attack while sprinting.<br>[Able to do sprinting power attack that deals 20% increased damage]",
     labels: [], lines: [], chainPerks: []
  },
  //5
  {
    name: "Axe Focus", skill: Onehanded, skillReq: 25,
     xPos: 40, yPos: 66, preReqs: [1], chain: 3,  rank: 1,
     description: "You've become familiar with one-handed axes.<br>[10% more damage, +7% armor penetration]",
     labels: [], lines: [], chainPerks: []
  },
  //6
  {
    name: "Axe Focus", skill: Onehanded, skillReq: 50,
     xPos: 40, yPos: 66, preReqs: [5], chain: 3,  rank: 2,
     description: "You've become an advanced one-handed axe fighter.<br>[20% more damage, +14% armor penetration]",
     labels: [], lines: [], chainPerks: []
  },
  //7
  {
    name: "Axe Focus", skill: Onehanded, skillReq: 75,
     xPos: 40, yPos: 66, preReqs: [6], chain: 3,  rank: 3,
     description: "You've become a master of one-handed axe combat.<br>[30% more damage, +21% armor penetration]",
     labels: [], lines: [], chainPerks: []
  },
  //8
  {
    name: "Blunt Weapon Focus", skill: Onehanded, skillReq: 25,
     xPos: 69, yPos: 66, preReqs: [1], chain: 3,  rank: 1,
     description: "You've learned some techniques to crush armor with maces, clubs, and mauls.<br>[5% more power attack damage, +12% armor penetration]",
     labels: [], lines: [], chainPerks: []
  },
  //9
  {
    name: "Blunt Weapon Focus", skill: Onehanded, skillReq: 50,
     xPos: 69, yPos: 66, preReqs: [8], chain: 3,  rank: 2,
     description: "You've become an advanced blunt weapon fighter and know how to find weak spots in enemy armor.<br>[10% more power attack damage, +24% armor penetration]",
     labels: [], lines: [], chainPerks: []
  },
  //10
  {
    name: "Blunt Weapon Focus", skill: Onehanded, skillReq: 75,
     xPos: 69, yPos: 66, preReqs: [9], chain: 3,  rank: 3,
     description: "You've become a masterly blunt weapon fighter, rendering armor almost useless.<br>[15% more power attack damage, +36% armor penetration]",
     labels: [], lines: [], chainPerks: []
  },
  //11
  {
    name: "Sword/Spear Focus", skill: Onehanded, skillReq: 25,
     xPos: 84, yPos: 64, preReqs: [1], chain: 3,  rank: 1,
     description: "You've learned the basics of one-handed sword and spear combat.<br>[+9% attack speed, +5% armor penetration]",
     labels: [], lines: [], chainPerks: []
  },
  //12
  {
    name: "Sword/Spear Focus", skill: Onehanded, skillReq: 50,
     xPos: 84, yPos: 64, preReqs: [11], chain: 3,  rank: 2,
     description: "You've acquired the advanced techniques of fighting with one-handed swords and spears.<br>[+18% attack speed, +10% armor penetration]",
     labels: [], lines: [], chainPerks: []
  },
  //13
  {
    name: "Sword/Spear Focus", skill: Onehanded, skillReq: 75,
     xPos: 84, yPos: 64, preReqs: [12], chain: 3,  rank: 3,
     description: "You've become a master of one-handed swords and spears.<br>[+27% attack speed, +15% armor penetration]",
     labels: [], lines: [], chainPerks: []
  },
  //14
  {
    name: "Storm of Steel", skill: Onehanded, skillReq: 30,
     xPos: 76, yPos: 81, preReqs: [0], chain: 0,
     description: "You've become very skilled in wielding two weapons at once.<br>[25% more dual-wield power attack damage]",
     labels: [], lines: [], chainPerks: []
  },
  //15
  {
    name: "Flurry", skill: Onehanded, skillReq: 60,
     xPos: 82, yPos: 76, preReqs: [14], chain: 0,
     description: "When fighting with two one-handed weapons, you are able to attack faster than normal.<br>[+15% attack speed]",
     labels: [], lines: [], chainPerks: []
  },
  //16
  {
  ...
  //17
  {
    name: "Spellblade Mastery", skill: Onehanded, skillReq: 50,
     xPos: 63, yPos: 76, preReqs: [16], chain: 2,  rank: 2,
  ...
  //18
  {
    name: "Martial Arts", skill: Onehanded, skillReq: 0,
     ...
     description: "You are a passionate fist fighter, and train regularly to toughen your muscles to their very limits.<br>[+25 unarmed damage, +0.5 unarmed damage for every character level]",
     labels: [], lines: [], chainPerks: []
  },
  //19
  {
    name: "Martial Arts", skill: Onehanded, skillReq: 0,
     xPos: 44, yPos: 77, preReqs: [18], chain: 2,  rank: 2,
     description: "[Requires Level 15]<br>Through relentless training your fists are now as hard as steel, allowing you to deliver devastating blows.<br>[+5 unarmed damage, Ignore 35% armor]",
     labels: [], lines: [], chainPerks: []
  },
  //20
  {
    name: "Dagger Focus", skill: Onehanded, skillReq: 25,
     xPos: 26, yPos: 66, preReqs: [1], chain: 3,  rank: 1,
     description: "You learned some dirty tricks for your dagger.<br>[15% chance to critically hit, critical hits deal 60% additional base dagger damage, +6% armor penetration]",
     labels: [], lines: [], chainPerks: []
  },
  //21
  {
    name: "Dagger Focus", skill: Onehanded, skillReq: 50,
     xPos: 26, yPos: 66, preReqs: [20], chain: 3,  rank: 2,
     description: "A dagger in your hand turns into a deadly weapon.<br>[critical hits deal 120% additional base dagger damage, +12% armor penetration]",
     labels: [], lines: [], chainPerks: []
  },
  //22
  {
    name: "Dagger Focus", skill: Onehanded, skillReq: 75,
     xPos: 26, yPos: 66, preReqs: [21], chain: 3,  rank: 3,
     description: "You have mastered the deadly art of the dagger.<br>[critical hits with daggers deal 180% additional base dagger damage, +18% armor penetration]",
     labels: [], lines: [], chainPerks: []
  },
];
...
Twohanded.perks = [
  //0
  {
    name: "Great Weapon Mastery", skill: Twohanded, skillReq: 0,
     xPos: 42, yPos: 85, preReqs: [], chain: 0,
  ...
  //1
  {
    name: "Barbaric Might", skill: Twohanded, skillReq: 20,
     xPos: 43, yPos: 73, preReqs: [0], chain: 0,
     description: "Your attacks become mighty blows that will penetrate armor and are even more devastating.<br>[+10% armor penetration, +5% damage]",
     labels: [], lines: [], chainPerks: []
  },
  //2
  {
    name: "Devastating Strike", skill: Twohanded, skillReq: 50,
     xPos: 51, yPos: 55, preReqs: [1], chain: 0,
     description: "Your two-handed combat style has improved so much that all power attacks have become devastating.<br>[15% more power attack damage]",
     labels: [], lines: [], chainPerks: []
  },
  //3
  {
    name: "Shatter Defense", skill: Twohanded, skillReq: 75,
     xPos: 31, yPos: 23, preReqs: [2,6], chain: 0,
     description: "Your power attacks are truly devastating, tearing right through the defenses of your enemies.<br>[Standing and backward power attacks ignore 8% armor and deal 100% increased damage against blocking enemies]  ",
     labels: [], lines: [], chainPerks: [], choiceNeeded: true
  },
  //4
  {
    name: "Devastating Cleave", skill: Twohanded, skillReq: 75,
     xPos: 51, yPos: 23, preReqs: [2,6], chain: 0,
  ...
  //5
  {
    name: "Mighty Strike", skill: Twohanded, skillReq: 100,
     xPos: 42, yPos: 1, preReqs: [3,4], chain: 0,
     description: "You can kill almost any foe with a single strike of your two-hander, as your blows even fell giants with ease.<br>[20% more damage]",
     labels: [], lines: [], chainPerks: [], choiceNeeded: true
  },
  //6
  {
    name: "Devastating Charge", skill: Twohanded, skillReq: 50,
     xPos: 31, yPos: 55, preReqs: [1], chain: 0,
     description: "You've learned to perform a leaping power attack while sprinting, reducing your enemies to smithereens.<br>[Able to do sprinting power attack that deals 10% increased damage]",
     labels: [], lines: [], chainPerks: []
  },
  //7
  {
    name: "Axe/Halberd Focus", skill: Twohanded, skillReq: 25,
     xPos: 16, yPos: 66, preReqs: [1], chain: 3,  rank: 1,
     description: "You've become familiar with two-handed axes and halberds.<br>[10% more damage, +7% armor penetration]",
     labels: [], lines: [], chainPerks: []
  },
  //8
  {
    name: "Axe/Halberd Focus", skill: Twohanded, skillReq: 50,
     xPos: 16, yPos: 66, preReqs: [7], chain: 3,  rank: 2,
     description: "You've become an advanced fighter with two-handed axes and halberds.<br>[20% more damage, +14% armor penetration]",
     labels: [], lines: [], chainPerks: []
  },
  //9
  {
    name: "Axe/Halberd Focus", skill: Twohanded, skillReq: 75,
     xPos: 16, yPos: 66, preReqs: [8], chain: 3,  rank: 3,
     description: "You've become a master of two-handed axes and halberds.<br>[30% more damage, +21% armor penetration]",
     labels: [], lines: [], chainPerks: []
  },
  //10
  {
    name: "Sword/Spear Focus", skill: Twohanded, skillReq: 25,
     xPos: 67, yPos: 66, preReqs: [1], chain: 3,  rank: 1,
     description: "You've learned the basics of two-handed sword and spear combat.<br>[+9% attack speed, +5% armor penetration]",
     labels: [], lines: [], chainPerks: []
  },
  //11
  {
    name: "Sword/Spear Focus", skill: Twohanded, skillReq: 50,
     xPos: 67, yPos: 66, preReqs: [10], chain: 3,  rank: 2,
     description: "You've acquired the advanced techniques of two-handed sword and spear combat.<br>[+18% attack speed, +10% armor penetration]",
     labels: [], lines: [], chainPerks: []
  },
  //12
  {
    name: "Sword/Spear Focus", skill: Twohanded, skillReq: 75,
     xPos: 67, yPos: 66, preReqs: [11], chain: 3,  rank: 3,
     description: "You've become a master of two-handed sword and spear combat.<br>[+27% attack speed, +15% armor penetration]",
     labels: [], lines: [], chainPerks: []
  },
  //13
  {
    name: "Blunt Weapon Focus", skill: Twohanded, skillReq: 25,
     xPos: 86, yPos: 66, preReqs: [1], chain: 3,  rank: 1,
     description: "You've learned some techniques to crush armor with warhammers, long maces, and battlestaffs.<br>[5% more power attack damage, +12% armor penetration]",
     labels: [], lines: [], chainPerks: []
  },
  //14
  {
    name: "Blunt Weapon Focus", skill: Twohanded, skillReq: 50,
     xPos: 86, yPos: 66, preReqs: [13], chain: 3,  rank: 2,
     description: "You've become an advanced blunt weapon fighter and know how to find weak spots in enemy armor.<br>[10% more power attack damage, +24% armor penetration]",
     labels: [], lines: [], chainPerks: []
  },
  //15
  {
    name: "Blunt Weapon Focus", skill: Twohanded, skillReq: 75,
     xPos: 86, yPos: 66, preReqs: [14], chain: 3,  rank: 3,
     description: "You've become a masterly blunt weapon fighter, rendering armor almost useless.<br>[15% more power attack damage, +36% armor penetration]",
     labels: [], lines: [], chainPerks: []
  },
];
...
Marksman.perks = [
  ...
  //3
  {
    name: "Quick Shot", skill: Marksman, skillReq: 40,
     ...
     description: "You have learned to draw and fire in one single movement.<br>[+35% draw speed with bows]",
     labels: [], lines: [], chainPerks: []
  },
  //4
  {
    name: "Rapid Reload", skill: Marksman, skillReq: 40,
     ...
     description: "Your have familiarized yourself with the mechanics of your crossbow and can use this knowledge to reload it significantly faster.<br>[+35% reload speed with crossbows]",
     labels: [], lines: [], chainPerks: []
  },
  //5
  {
  ...
  //8
  {
    name: "Piercing Shot", skill: Marksman, skillReq: 40,
     xPos: 77, yPos: 60, preReqs: [11,7], chain: 0,
  ...
  //10
  {
    name: "Ranger", skill: Marksman, skillReq: 15,
     ...
     description: "You refined your footwork in combat, allowing for improved movement and more effective hits with light ranged weapons.<br>[15% increased damage, able to run with light ranged weapons]",
     labels: [], lines: [], chainPerks: []
  },
  //11
  {
    name: "Hunter", skill: Marksman, skillReq: 20,
     xPos: 71, yPos: 73, preReqs: [0], chain: 0,
     description: "You are more adapted to wildlife, and better understand its inhabitants.<br>[+25% physical damage against animals, +10% poison and disease resist, increased stealth in the wilderness]",
     labels: [], lines: [], chainPerks: []
  },
  //12
  {
    name: "Bow Strike", skill: Marksman, skillReq: 25,
     xPos: 31, yPos: 69, preReqs: [10], chain: 0,
     description: "You can use your bow or crossbow as melee weapon in close combat.<br>[+70 bash damage, improved stagger damage]",
     labels: [], lines: [], chainPerks: []
  },
];
...
Block.perks = [
  ...
  //1
  {
    name: "Strong Grip", skill: Block, skillReq: 15,
     ...
     description: "You hold on to your shield like you would hold on to your life.<br>[75% less shield weight, 10% more armor rating, block 30% more damage]",
     labels: [], lines: [], chainPerks: []
  },
  //2
  {
  ...
  //7
  {
    name: "Disarming Bash", skill: Block, skillReq: 75,
     ...
     description: "Sometimes, when you put all your strength into your bashes, your foes drop their weapon because of the pain.<br>[25% chance to disarm when power bashing with a shield, 15% chance to disarm when power bashing with a weapon]",
     labels: [], lines: [], chainPerks: []
  },
  //8
  {
    name: "Experienced Blocking", skill: Block, skillReq: 20,
     ...
     description: "With weapon or shield you can block almost any blow with rock-solid confidence.<br>[Block 20% more damage, recover some stamina when blocking a hit]",
     labels: [], lines: [], chainPerks: []
  },
  //9
  {
...
Smithing.perks = [
  ...
  //1
  {
    name: "Orcish Smithing", skill: Smithing, skillReq: 25,
  ...
  //2
  {
    name: "Dwarven Smithing", skill: Smithing, skillReq: 50,
  ...
  //3
  {
    name: "Ebony Smithing", skill: Smithing, skillReq: 75,
     xPos: 82, yPos: 44, preReqs: [1,14,3,8], chain: 0,
  ...
  //8
  {
    name: "Nordic Smithing", skill: Smithing, skillReq: 55,
     xPos: 84, yPos: 62, preReqs: [13,15,2], chain: 0,
  ...
  //15
  {
    name: "Morrowind Smithing", skill: Smithing, skillReq: 25,
     xPos: 66, yPos: 71, preReqs: [0,15], chain: 0,
     description: "Dunmer are masters of the processing of bone of the fauna of Morrowind, <br>but you have mastered their knowledge with the help of this compendium written by the famous blacksmith of Morrowind.",
     labels: [], lines: [], chainPerks: []
  },
];
...
HeavyArmor.perks = [
  ...
  //8
  {
    name: "Juggernaut", skill: HeavyArmor, skillReq: 100,
     ...
     description: "You've reached perfection in the skill of wearing heavy armor and are now significantly more maneuverable in it.<br>[15% less armor weight, 10% more armor rating, stagger immunity when wearing all heavy armor: head, chest, hands, feet]",
     labels: [], lines: [], chainPerks: []
  },
  //9
  {
    name: "Endurance Training", skill: HeavyArmor, skillReq: 20,
     xPos: 48, yPos: 71, preReqs: [0], chain: 0,
     description: "After extensive training you now can move in heavy armor without problems.<br>[reduced sprinting stamina cost penalty, 25% less heavy armor dodge penalty, -15% armor weight penalty]",
     labels: [], lines: [], chainPerks: []
  },
];
...
Evasion.perks = [
  ...
  //1
  {
    name: "Finesse", skill: Evasion, skillReq: 25,
     ...
     description: "Your fluid motion causes enemy attacks to glance off you.<br>[Up to 40% physical damage reduction while sprinting that decreases with every piece of heavy armor equipped]",
     labels: [], lines: [], chainPerks: []
  },
  //2
  {
    name: "Vexing Flanker", skill: Evasion, skillReq: 75,
     ...
     description: "You have learned to flank your enemies with ease.<br>[Up to 18% more melee attack damage when running that decreases with every piece of heavy armor equipped, immune to finishers]",
     labels: [], lines: [], chainPerks: []
  },
  //3
  {
    name: "Meteoric Reflexes", skill: Evasion, skillReq: 100,
     xPos: 50, yPos: 17, preReqs: [2,5], chain: 0,
     description: "Your reflexes are lightning fast.<br>[50% chance to take 70% less melee damage when wearing no heavy armor]",
     labels: [], lines: [], chainPerks: [], choiceNeeded: true
  },
  //4
  {
    name: "Wind Walker", skill: Evasion, skillReq: 50,
     ...
     description: "Your light armor and clothes have become your second skin.<br>[Up to +10% movement speed that decreases with every piece of heavy armor equipped, -25% armor weight penalty]",
     labels: [], lines: [], chainPerks: []
  },
  //5
  {
  ...
  //7
  {
    name: "Dexterity", skill: Evasion, skillReq: 50,
     ...
     description: "You are able to balance your weapon better.<br>[Up to 24% less power attack stamina cost that decreases with every piece of heavy armor equipped]",
     labels: [], lines: [], chainPerks: []
  },
  //8
  {
    name: "Athletics", skill: Evasion, skillReq: 30,
     xPos: 82, yPos: 70, preReqs: [0], chain: 2,  rank: 1,
     description: "You are more agile and can recover from exhaustion faster when wearing no heavy armor.<br>[+10% movement speed when sprinting or swimming, +20% stamina regeneration]",
     labels: [], lines: [], chainPerks: []
  },
  //9
  {
    name: "Athletics", skill: Evasion, skillReq: 60,
     xPos: 82, yPos: 70, preReqs: [8], chain: 2,  rank: 2,
     description: "You are more agile and can recover from exhaustion faster when wearing no heavy armor.<br>[+20% movement speed when sprinting or swimming, +40% stamina regeneration]",
     labels: [], lines: [], chainPerks: []
  },
  //10
  {
    name: "Unarmored", skill: Evasion, skillReq: 20,
     xPos: 25, yPos: 77, preReqs: [0], chain: 2,  rank: 1,
     description: "Having no weight on your body allows you to control your moves better in combat.<br>[while unarmored: +60 armor rating, +5% movement speed, +15% stamina regeneration]",
     labels: [], lines: [], chainPerks: []
  },
  //11
  {
    name: "Unarmored", skill: Evasion, skillReq: 40,
     xPos: 25, yPos: 77, preReqs: [10], chain: 2,  rank: 2,
     description: "Having no weight on your body allows you to control your moves better in combat.<br>[while unarmored: +120 armor rating, +10% movement speed, +30% stamina regen]",
     labels: [], lines: [], chainPerks: []
  },
];
...
Pickpocket.perks = [
  //0
  {
    name: "Nimble Fingers", skill: Pickpocket, skillReq: 0,
     xPos: 25, yPos: 85, preReqs: [], chain: 2,  rank: 1,
  ...
  //1
  {
    name: "Nimble Fingers", skill: Pickpocket, skillReq: 15,
     xPos: 25, yPos: 85, preReqs: [0], chain: 2,  rank: 2,
  ...
  //3
  {
    name: "Cutpurse", skill: Pickpocket, skillReq: 40,
     xPos: 39, yPos: 70, preReqs: [2], chain: 2,  rank: 2,
  ...
  //4
  {
    name: "Nightly Thief", skill: Pickpocket, skillReq: 50,
     xPos: 54, yPos: 49, preReqs: [2], chain: 0,
  ...
  //5
  {
    name: "Misdirection", skill: Pickpocket, skillReq: 75,
     xPos: 64, yPos: 22, preReqs: [4], chain: 0,
  ...
  //6
  {
    name: "Perfected Art", skill: Pickpocket, skillReq: 100,
     xPos: 82, yPos: 17, preReqs: [5], chain: 0,
  ...
  //7
  {
    name: "Mighty Greed", skill: Pickpocket, skillReq: 25,
     xPos: 74, yPos: 75, preReqs: [2], chain: 0,
...
Lockpicking.perks = [
  //0
  {
    name: "Cheap Tricks", skill: Lockpicking, skillReq: 0,
     xPos: 31, yPos: 85, preReqs: [], chain: 0,
     description: "You have learned the basics of the art of picking locks and gain 30 expertise. You can now pick novice and apprentice locks without difficulty. If you apply some basic smithing techniques, you can even forge lockpicks.",
     labels: [], lines: [], chainPerks: []
  },
  //1
  {
    name: "Locksmithing Lore", skill: Lockpicking, skillReq: 45,
     ...
     description: "You have extended your repertoire of lockpicking tricks, which increases your expertise by an additional 30 points.<br>Adept locks can be picked without effort and you are able to remember your lockpick's angle after they break.",
     labels: [], lines: [], chainPerks: []
  },
  //2
  {
    name: "Masterly Lockpicking", skill: Lockpicking, skillReq: 90,
     ...
     description: "You learned everything there is to know about the art of lockpicking. Your expertise increases by 40 points,<br>you can now pick expert locks without difficulty and locks can be picked in plain sight with nobody noticing.",
     labels: [], lines: [], chainPerks: []
  },
  //3
  {
...
Sneak.perks = [
  ...
  //1
  {
    name: "Stealth", skill: Sneak, skillReq: 15,
  ...
  //2
  {
    name: "Deft Strike", skill: Sneak, skillReq: 25,
     ...
     description: "You've learned to exploit weaknesses in your foes' armor when sneak attacking with daggers, bows, crossbows or swords.<br>[Ignore 50% armor when attacking while not detected]",
     labels: [], lines: [], chainPerks: []
  },
  //3
  {
    name: "Anatomical Lore", skill: Sneak, skillReq: 50,
     ...
     description: "Your knowledge of anatomy allows you to deal immense damage to humanoids that are vulnerable to sneak attacks.<br>[x2 for ranged weapons/spells, x5 for melee weapons]",
     labels: [], lines: [], chainPerks: []
  },
  //4
  {
...
Alchemy.perks = [
  ...
  //3
  {
    name: "Improved Elixirs", skill: Alchemy, skillReq: 25,
     xPos: 83, yPos: 80, preReqs: [0], chain: 0,
  ...
  //4
  {
    name: "Catalysis", skill: Alchemy, skillReq: 50,
     xPos: 60, yPos: 43, preReqs: [12,3], chain: 2,  rank: 1,
  ...
  //5
  {
    name: "Catalysis", skill: Alchemy, skillReq: 100,
     xPos: 60, yPos: 43, preReqs: [4], chain: 2,  rank: 2,
  ...
  //6
  {
    name: "Immunization", skill: Alchemy, skillReq: 75,
     xPos: 60, yPos: 27, preReqs: [4], chain: 0,
  ...
  //7
  {
    name: "Purification Process", skill: Alchemy, skillReq: 100,
     xPos: 60, yPos: 4, preReqs: [6], chain: 0,
  ...
  //8
  {
    name: "Fortified Muscles", skill: Alchemy, skillReq: 75,
     xPos: 47, yPos: 17, preReqs: [6,8], chain: 0,
  ...
  //9
  {
    name: "Alchemical Intellect", skill: Alchemy, skillReq: 100,
     xPos: 74, yPos: 18, preReqs: [6,9], chain: 0,
  ...
  //10
  {
    name: "Night Vision", skill: Alchemy, skillReq: 25,
     xPos: 55, yPos: 73, preReqs: [0,10], chain: 0,
  ...
  //11
  {
    name: "Regeneration", skill: Alchemy, skillReq: 50,
     xPos: 78, yPos: 46, preReqs: [11,3], chain: 0,
  ...
  //12
  {
    name: "Concentrated Poisons", skill: Alchemy, skillReq: 25,
     xPos: 41, yPos: 66, preReqs: [0], chain: 0,
  ...
  //13
  {
    name: "Improved Poisons", skill: Alchemy, skillReq: 50,
     xPos: 42, yPos: 45, preReqs: [12], chain: 0,
  ...
  //14
  {
    name: "Drunken Combat", skill: Alchemy, skillReq: 0,
     xPos: 23, yPos: 75, preReqs: [], chain: 0,
...
Speech.perks = [
  ...
  //1
  {
    name: "Haggling", skill: Speech, skillReq: 35,
  ...
  //2
  {
    name: "Haggling", skill: Speech, skillReq: 70,
  ...
  //6
  {
    name: "Masquerade", skill: Speech, skillReq: 75,
     xPos: 12, yPos: 33, preReqs: [5], chain: 0,
     description: "You've become a professional at acting, and with the right equipment you can now disguise yourself.<br>Only the sharpest minds might detect your true identity.  ",
     labels: [], lines: [], chainPerks: []
  },
  //7
  {
  ...
  //9
  {
    name: "Tongue's Insight", skill: Speech, skillReq: 0,
     xPos: 86, yPos: 17, preReqs: [8], chain: 0,
  ...
  //10
  {
    name: "Spiritual Equilibrium", skill: Speech, skillReq: 0,
     xPos: 59, yPos: 49, preReqs: [8], chain: 0,
  ...
  //11
  {
    name: "Indomitable Force", skill: Speech, skillReq: 0,
     xPos: 56, yPos: 70, preReqs: [8], chain: 0,
  ...
  //12
  {
    name: "Destructive Urge", skill: Speech, skillReq: 0,
     xPos: 61, yPos: 85, preReqs: [8], chain: 0,
  ...
  //13
  {
    name: "The Way of the Voice", skill: Speech, skillReq: 0,
     xPos: 68, yPos: 28, preReqs: [8], chain: 0,
...
Alteration.perks = [
  ...
  //6
  {
    name: "Spell Armor", skill: Alteration, skillReq: 75,
     ...
     description: "You've expanded the versatility of your Mage Armor and Elemental Shell spells by enabling them to decrease incoming elemental damage.<br>[15% reduced damage, Shell spells lasts 5x longer]",
     labels: [], lines: [], chainPerks: []
  },
  //7
  {
    name: "Stability", skill: Alteration, skillReq: 50,
     ...
     description: "You've become exceptionally good at making your alteration spells more stable. Thus, they now last longer.<br>[+75% duration]",
     labels: [], lines: [], chainPerks: []
  },
  //8
  {
  ...
  //10
  {
    name: "Improved Mage Armor", skill: Alteration, skillReq: 25,
     ...
     description: "You've mastered the art of casting armor spells, their effect is increased by 20%, and they last 5 times longer. Additionally you take 20% less damage from ranged attacks while a mage armor spell is active. (less effective when wearing light/heavy armor)",
     labels: [], lines: [], chainPerks: []
  },
  //11
  {
  ...
  //12
  {
    name: "Metallurgy", skill: Alteration, skillReq: 40,
     xPos: 55, yPos: 67, preReqs: [11], chain: 2,  rank: 2,
  ...
  //13
  {
    name: "Rust", skill: Alteration, skillReq: 65,
     xPos: 84, yPos: 49, preReqs: [11], chain: 0,
  ...
  //14
  {
    name: "Corrosion Mastery", skill: Alteration, skillReq: 90,
     xPos: 87, yPos: 11, preReqs: [13], chain: 0,
     description: "Your mastery over corrosion grants you the ability to penetrate armor with weapons, while also empowering your corrosion spells even further.<br>[12% armor penetration, +5% magnitude, -10% spell cost]  ",
     labels: [], lines: [], chainPerks: []
  },
  //15
  {
  ...
  //16
  {
    name: "Aeromancy", skill: Alteration, skillReq: 40,
     xPos: 25, yPos: 67, preReqs: [15], chain: 2,  rank: 2,
  ...
  //17
  {
    name: "Aeromantic Strength", skill: Alteration, skillReq: 65,
     xPos: 18, yPos: 49, preReqs: [15], chain: 0,
  ...
  //18
  {
    name: "Aeromantic Mastery", skill: Alteration, skillReq: 90,
     xPos: 8, yPos: 17, preReqs: [17], chain: 0,
  ...
  //19
  {
    name: "Adaptive Transmutation", skill: Alteration, skillReq: 35,
     xPos: 59, yPos: 49, preReqs: [1], chain: 2,  rank: 1,
     description: "By transmuting the forces around you, you can alter your resistance to fire, shock, frost, or poison at will.<br>[+10% resistance to either fire, frost, shock, or poison]",
     labels: [], lines: [], chainPerks: []
  },
  //20
  {
    name: "Adaptive Transmutation", skill: Alteration, skillReq: 70,
     xPos: 59, yPos: 49, preReqs: [19], chain: 2,  rank: 2,
     description: "Your mastery of transmutation deepens, allowing you to further fortify your resistances.<br>[+20% resistance to either fire, frost, shock, or poison]",
     labels: [], lines: [], chainPerks: []
  },
  //21
  {
  ...
  {
    name: "Innate Sorcery", skill: Alteration, skillReq: 0,
     xPos: 27, yPos: 79, preReqs: [22], chain: 4,  rank: 2,
     description: "[Requires Level 10]<br>As you delve deeper into the realm of magic, you gain the ability to cast apprentice-level spells.<br>[-70% spell cost]",
     labels: [], lines: [], chainPerks: []
  },
  //24
  {
    name: "Innate Sorcery", skill: Alteration, skillReq: 0,
     xPos: 27, yPos: 79, preReqs: [23], chain: 4,  rank: 3,
     description: "[Requires Level 20]<br>Your growing understanding of magical principles allows you to cast adept-level spells.<br>[-65% spell cost]",
     labels: [], lines: [], chainPerks: []
  },
  //25
  {
...
Conjuration.perks = [
  ...
  //5
  {
    name: "Cognitive Flexibility", skill: Conjuration, skillReq: 60,
     xPos: 34, yPos: 58, preReqs: [0], chain: 2,  rank: 1,
     description: "You have practiced the mental ability of maintaining two summons at the same time. However, this requires great amounts of magical power. <br> [+15% manacost for summoning spells]",
     labels: [], lines: [], chainPerks: []
  },
  //6
  {
    name: "Cognitive Flexibility", skill: Conjuration, skillReq: 100,
     xPos: 34, yPos: 58, preReqs: [5], chain: 2,  rank: 2,
     description: "You've mastered the art of Cognitive Flexibility, allowing you to summon three summons at the cost of vast amounts of magical power. <br> [+35% manacost for summoning spells]",
     labels: [], lines: [], chainPerks: []
  },
  //7
  {
    name: "Necromancy", skill: Conjuration, skillReq: 25,
     ...
     description: "Spells that summon or raise the dead and ghosts last longer and can raise more powerful entities.<br>[Raise Dead: duration x10/magnitude x1.25, Summon Undead: duration x1.5]",
     labels: [], lines: [], chainPerks: []
  },
  //8
  {
    name: "Necromancy", skill: Conjuration, skillReq: 50,
     xPos: 41, yPos: 54, preReqs: [7], chain: 2,  rank: 2,
     description: "Spells that summon or raise the dead and ghosts last even longer and can raise even more powerful entities.<br>[Raise Dead: duration x20/magnitude x1.5, Summon Undead: duration x2]",
     labels: [], lines: [], chainPerks: []
  },
  //9
  {
    name: "Ritualism", skill: Conjuration, skillReq: 50,
     xPos: 41, yPos: 44, preReqs: [7], chain: 0,
  ...
  //10
  {
    name: "Dark Infusion", skill: Conjuration, skillReq: 75,
     xPos: 35, yPos: 22, preReqs: [9], chain: 0,
  ...
  //12
  {
    name: "Mystic Maelstrom", skill: Conjuration, skillReq: 40,
     xPos: 58, yPos: 43, preReqs: [11], chain: 0,
  ...
  //13
  {
    name: "Mystic Banishment", skill: Conjuration, skillReq: 65,
     xPos: 56, yPos: 27, preReqs: [12], chain: 0,
  ...
  //14
  {
    name: "Mystic Disruption", skill: Conjuration, skillReq: 90,
     xPos: 53, yPos: 12, preReqs: [13], chain: 0,
  ...
  //15
  {
    name: "Stabilized Binding", skill: Conjuration, skillReq: 25,
     ...
     description: "Having studied the barriers that divide the planes of existence, your non-undead summoned creatures last longer in this realm.<br>[+100% duration]",
     labels: [], lines: [], chainPerks: []
  },
  //16
  {
    name: "Stabilized Binding", skill: Conjuration, skillReq: 50,
     xPos: 25, yPos: 65, preReqs: [15], chain: 2,  rank: 2,
     description: "Furthering your studies about the barriers that divide the planes of existence, your non-undead summoned creatures last even longer in this realm.<br>[+200% duration]",
     labels: [], lines: [], chainPerks: []
  },
  //17
  {
    name: "Extended Binding", skill: Conjuration, skillReq: 50,
     xPos: 17, yPos: 38, preReqs: [15], chain: 0,
     description: "You've perfected your spells' formulae to summon non-undead creatures, and are now able to cast them more easily and further away.<br>[x10 range, -20% spell cost]",
     labels: [], lines: [], chainPerks: []
  },
  //18
  {
    name: "Elemental Binding", skill: Conjuration, skillReq: 75,
     xPos: 17, yPos: 6, preReqs: [17], chain: 0,
     description: "Your knowledge of Oblivion's elemental aspects increases the strength of all your summoned Atronachs and increases their duration by 100%.",
     labels: [], lines: [], chainPerks: []
  },
  //19
  {
    name: "Spiritual Binding", skill: Conjuration, skillReq: 35,
     xPos: 25, yPos: 48, preReqs: [15], chain: 0,
  ...
  //21
  {
    name: "Soulmancer", skill: Conjuration, skillReq: 40,
     ...
     description: "You now are able to intensify the potency of your soul spells.<br>[+40% magnitude]<br>(Unrelated to Perk: Soul spells deal up to 60% less damage depending on the targets current magicka)",
     labels: [], lines: [], chainPerks: []
  },
  //22
  {
    name: "Enslavement", skill: Conjuration, skillReq: 65,
     xPos: 86, yPos: 33, preReqs: [20], chain: 0,
     description: "You raise foes up to level 20 that are slain with your adept or higher soul spells.<br>[They don't count towards summon limit, duration = 120 sec]",
     labels: [], lines: [], chainPerks: []
  },
  //23
  {
    name: "Enthrallment", skill: Conjuration, skillReq: 90,
     xPos: 85, yPos: 12, preReqs: [22], chain: 0,
     description: "You raise most foes that are slain with your adept or higher soul spells.<br>[They don't count towards summon limit, duration = 240 sec]",
     labels: [], lines: [], chainPerks: []
  },
];
...
Destruction.perks = [
  ...
  //5
  {
    name: "Extended Cloaks", skill: Destruction, skillReq: 50,
     xPos: 74, yPos: 33, preReqs: [2], chain: 2,  rank: 1,
     description: "Specialising in cloak spells allows you to empower them with increased duration and increased area of effect.<br>[+50% area, +75% duration]",
     labels: [], lines: [], chainPerks: []
  },
  //6
  {
    name: "Extended Cloaks", skill: Destruction, skillReq: 75,
     ...
     description: "Your mastery over cloak spells allows you to empower them with even greater duration and area of effect.<br>[+100% area, +150% duration]",
     labels: [], lines: [], chainPerks: []
  },
  //7
  {
    name: "Rune Mastery", skill: Destruction, skillReq: 50,
     ...
     description: "You have unlocked the secret of maintaining two active runes instead of just one. You can also cast runes at double the distance.",
     labels: [], lines: [], chainPerks: []
  },
  //8
  {
    name: "Rune Mastery", skill: Destruction, skillReq: 75,
     ...
     description: "You have unlocked the secret of maintaining three active runes instead of just one. You can also cast runes at triple times the distance.",
     labels: [], lines: [], chainPerks: []
  },
  //9
  {
  ...
  //10
  {
    name: "Enhanced Infusions", skill: Destruction, skillReq: 60,
     ...
     description: "You are able to intensify the power of your infusion spells even further, increasing their power and duration.<br>[+30% magnitude, x10 duration]",
     labels: [], lines: [], chainPerks: []
  },
  //11
  {
  ...
  //19
  {
    name: "Electromancy", skill: Destruction, skillReq: 20,
     ...
     description: "You can now energize your lightning spells more effectively, causing them to deal more damage when your mind is clear and focused.<br>[Over 75% Magicka: +25% magnitude]",
     labels: [], lines: [], chainPerks: []
  },
  //20
  {
    name: "Electromancy", skill: Destruction, skillReq: 40,
     ...
     description: "You can now energize your lightning spells even more effectively, causing them to deal devastating damage when your mind is clear and focused.<br>[Over 75% Magicka: +50% magnitude]",
     labels: [], lines: [], chainPerks: []
  },
  //21
  {
  ...
  //23
  {
    name: "Impact", skill: Destruction, skillReq: 50,
     xPos: 83, yPos: 32, preReqs: [2], chain: 0,
  ...
  //24
  {
    name: "Hemomancer", skill: Destruction, skillReq: 20,
     ...
     description: "Killing an enemy with your destruction drain spells empowers you for a short period of time.<br>[Buff grants: +15% magnitude to drain spells, +1 health/sec for 600 seconds]",
     labels: [], lines: [], chainPerks: []
  },
  //25
  {
    name: "Hemomancer", skill: Destruction, skillReq: 40,
     xPos: 39, yPos: 65, preReqs: [24], chain: 2,  rank: 2,
     description: "Killing an enemy with your destruction drain spells now greatly empowers you for an extended period.<br>[Buff grants: +30% magnitude to drain spells, +1 health/sec for 1800 seconds]",
     labels: [], lines: [], chainPerks: []
  },
  //26
  {
    name: "Drain Strength", skill: Destruction, skillReq: 65,
     xPos: 35, yPos: 44, preReqs: [24], chain: 0,
  ...
  //27
  {
    name: "Drain Willpower", skill: Destruction, skillReq: 90,
     xPos: 34, yPos: 22, preReqs: [26], chain: 0,
  ...
  //28
  {
    name: "Annihilation", skill: Destruction, skillReq: 20,
     ...
     description: "You now are able to intensify the strength of your Annihilation spells by channeling additional magicka into them.<br>[+20% magnitude, +12.5% spellcost]",
     labels: [], lines: [], chainPerks: []
  },
  //29
  {
    name: "Annihilation", skill: Destruction, skillReq: 40,
     xPos: 31, yPos: 65, preReqs: [28], chain: 2,  rank: 2,
     description: "You now are able to greatly intensify the strength of your Annihilation spells by weaving massive amounts of magicka into them.<br>[+40% magnitude, +25% spell cost]  ",
     labels: [], lines: [], chainPerks: []
  },
  //30
  {
    name: "Obliteration", skill: Destruction, skillReq: 65,
     xPos: 25, yPos: 49, preReqs: [28], chain: 0,
  ...
  //31
  {
    name: "Annihilation Mastery", skill: Destruction, skillReq: 90,
     xPos: 24, yPos: 17, preReqs: [30], chain: 0,
     description: "Your mastery over annihilation grants you magic resistance, while also empowering your annihilation spells even further.<br>[+8% resistance, +5% magnitude, -10% spell cost]",
     labels: [], lines: [], chainPerks: []
  },
  //32
  {
  ...
  //33
  {
    name: "Geomancy", skill: Destruction, skillReq: 40,
     xPos: 21, yPos: 65, preReqs: [32], chain: 2,  rank: 2,
  ...
  //34
  {
    name: "Knockout", skill: Destruction, skillReq: 65,
     xPos: 17, yPos: 44, preReqs: [32], chain: 0,
  ...
  //35
  {
    name: "Earth Mastery", skill: Destruction, skillReq: 90,
     xPos: 16, yPos: 12, preReqs: [34], chain: 0,
...
Illusion.perks = [
  ...
  //1
  {
    name: "Quiet Casting", skill: Illusion, skillReq: 25,
     xPos: 14, yPos: 70, preReqs: [0], chain: 0,
     description: "Empowering Muffle spells and Veil of Silence lets you cast spells from the illusion school silently. Muffle spells last 5 times longer.",
     labels: [], lines: [], chainPerks: []
  },
  //2
  {
  ...
  //3
  {
    name: "Unbreakable Invisibility", skill: Illusion, skillReq: 75,
     ...
     description: "Your invisibility spells now reapply themselves when you crouch while the effect is active. Invisibility and Muffle spells last 100% longer.",
     labels: [], lines: [], chainPerks: []
  },
  //4
  {
    name: "Visual Manipulation", skill: Illusion, skillReq: 25,
     ...
     description: "Your knowledge of Shadow Magic grants the power to summon night vision at will. Blur and Shadow Shield are more effective and last 50% longer.",
     labels: [], lines: [], chainPerks: []
  },
  //5
  {
    name: "Shadow Shaping", skill: Illusion, skillReq: 50,
     ...
     description: "You have gained even deeper insights into the weave of shadows. Blur and Shadow Shield are more powerful and last 100% longer. Empowering Shadow Shield grants immunity to most impact effects and increases attack speed by 10%.",
     labels: [], lines: [], chainPerks: []
  },
  //6
  {
    name: "Shadow Mastery", skill: Illusion, skillReq: 75,
     ...
     description: "You have mastered the weave of shadows. Shadow Simulacrum and Mistress of the Dark last 100% longer and illusions are improved when empowered. Blur and Shadow Shield are more effective and last 100% longer.",
     labels: [], lines: [], chainPerks: []
  },
  //7
  {
  ...
  //10
  {
    name: "Adept Illusion", skill: Illusion, skillReq: 50,
     xPos: 48, yPos: 48, preReqs: [9], chain: 0,
  ...
  //11
  {
    name: "Expert Illusion", skill: Illusion, skillReq: 75,
     xPos: 48, yPos: 33, preReqs: [10], chain: 0,
  ...
  //12
  {
    name: "Master Illusion", skill: Illusion, skillReq: 100,
     xPos: 48, yPos: 18, preReqs: [11], chain: 0,
  ...
  //13
  {
    name: "Domination", skill: Illusion, skillReq: 90,
     xPos: 70, yPos: 17, preReqs: [11], chain: 0,
  ...
  //14
  {
    name: "Obliterate the Mind", skill: Illusion, skillReq: 65,
     xPos: 70, yPos: 34, preReqs: [10], chain: 0,
  ...
  //15
  {
    name: "Pain and Agony", skill: Illusion, skillReq: 40,
     xPos: 70, yPos: 51, preReqs: [9], chain: 0,
...
Restoration.perks = [
  ...
  //6
  {
    name: "Respite", skill: Restoration, skillReq: 75,
     ...
     description: "You've mastered the art of healing spells which makes them even more effective and they are now able to restore stamina in combat.<br>[+10% magnitude]",
     labels: [], lines: [], chainPerks: []
  },
  //7
  {
  ...
  //13
  {
    name: "Venomancer", skill: Restoration, skillReq: 20,
     ...
     description: "You now are able to intensify the potency of your poison spells. Thus, they now have increased duration and magnitude.<br>[+10% magnitude, +15% duration]",
     labels: [], lines: [], chainPerks: []
  },
  //14
  {
    name: "Venomancer", skill: Restoration, skillReq: 40,
     ...
     description: "You now are able to greatly intensify the potency of your poison spells. Thus, they now deal far more damage and have even greater duration.<br>[+20% magnitude, +30% duration]",
     labels: [], lines: [], chainPerks: []
  },
  //15
  {
  ...
  //18
  {
    name: "Power of Life", skill: Restoration, skillReq: 50,
     xPos: 70, yPos: 43, preReqs: [17], chain: 0,
     description: "The power of life flows through you, reinforcing your body as long as you stay uninjured.<br>[Reduces all incoming damage by 25% while on full health]",
     labels: [], lines: [], chainPerks: []
  },
  //19
  {
    name: "Essence of Life", skill: Restoration, skillReq: 75,
     xPos: 90, yPos: 49, preReqs: [18], chain: 0,
     description: "Your understanding of healing and how magic and life are intertwined grant you the power of making yourself almost invulnerable for a short duration once a day.",
     labels: [], lines: [], chainPerks: []
  },
];
...
Enchanting.perks = [
  ...
  //1
  {
    name: "Enchanter's Insight", skill: Enchanting, skillReq: 30,
     ...
     description: "Your advanced knowledge of arcane energy enhances all your enchantments, increasing their power by 15% and reducing their energy consumption by 10%.                                                                                                                                                          ",
     labels: [], lines: [], chainPerks: []
  },
  //2
  {
    name: "Enchanter's Insight", skill: Enchanting, skillReq: 60,
     ...
     description: "Through obscure arcane knowledge your enchantments are amplified even further, increasing their power by another 15% and reducing their energy consumption by another 10%.",
     labels: [], lines: [], chainPerks: []
  },
  //3
  {
    name: "Elemental Lore", skill: Enchanting, skillReq: 25,
     ...
     description: "You've learned how to tame the elements most efficiently. Thus, all elemental enchantments are 50% stronger.",
     labels: [], lines: [], chainPerks: []
  },
  //4
  {
    name: "Corpus Lore", skill: Enchanting, skillReq: 50,
     ...
     description: "You've become skilled in using enchantments to strengthen mind and body. Thus, all such enchantments are 50% stronger.",
     labels: [], lines: [], chainPerks: []
  },
  //5
  {
    name: "Skill Lore", skill: Enchanting, skillReq: 75,
     ...
     description: "You've become a master of infusing enchantments that transfer knowledge and skill to the user, making all such ones 50% stronger.",
     labels: [], lines: [], chainPerks: []
  },
  //6
  {
    name: "Enchantment Mastery", skill: Enchanting, skillReq: 100,
     ...
     description: "You've found a way to bind more energy into inanimate matter. Thus, you can bend the Law of Firsts, allowing you to enchant two effects onto one item. Additionally, you can create Daedric staves and enchanted items consume 20% less energy.",
     labels: [], lines: [], chainPerks: [], choiceNeeded: true
  },
  //7
  {
  ...
  //8
  {
    name: "Arcane Experimentation", skill: Enchanting, skillReq: 50,
     ...
     description: "Your studies have enabled you to research unique enchantments of your own and to craft better staves at the forge. Additionally, your enchantments are 15% stronger.",
     labels: [], lines: [], chainPerks: []
  },
  //9
  {
    name: "Artificer's Insight", skill: Enchanting, skillReq: 75,
     ...
     description: "You could fill grimoires with your newfound knowledge that allows you to create even staves and further strengthens your enchantments by 15%.",
     labels: [], lines: [], chainPerks: []
  },
  //10
  {
    name: "Staff Channeling", skill: Enchanting, skillReq: 25,
     xPos: 33, yPos: 76, preReqs: [11], chain: 0,
     description: "You can use your magic staff to channel arcane power, making spells, scrolls, and staffs stronger.<br>[while having staff equipped: +10% magnitude and duration, -35% staff charge cost]",
     labels: [], lines: [], chainPerks: []
  },
  //11
  {
    name: "Arcane Artificery", skill: Enchanting, skillReq: 15,
     xPos: 30, yPos: 85, preReqs: [], chain: 0,
     description: "Your understanding of enchantments allows you to use scrolls and staff more effectively.<br>[+30% staff & scroll magnitude and duration]",
     labels: [], lines: [], chainPerks: []
  },
  //12
  {
    name: "Arcane Scholar", skill: Enchanting, skillReq: 30,
     xPos: 19, yPos: 70, preReqs: [11], chain: 3,  rank: 1,
     description: "Through meticulous study, you unlock hidden potentials in scrolls and staffs, boosting their spell magnitude and duration.<br>[+0.9% magnitude/duration for each point in your Enchantment skill]",
     labels: [], lines: [], chainPerks: []
  },
  //13
  {
    name: "Arcane Scholar", skill: Enchanting, skillReq: 65,
     xPos: 19, yPos: 70, preReqs: [12], chain: 3,  rank: 2,
  ...
  //14
  {
    name: "Arcane Scholar", skill: Enchanting, skillReq: 100,
     xPos: 19, yPos: 70, preReqs: [12], chain: 3,  rank: 3,
     description: "Through meticulous study, you unlock hidden potentials in scrolls and staffs, boosting their spell magnitude and duration.<br>[+2% magnitude/duration for each point in your Enchantment skill]",
     labels: [], lines: [], chainPerks: []
  },
];
